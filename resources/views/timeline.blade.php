              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                   <img class="img-fluid" src="{{ asset('images/'.$galeri->foto) }}" width="400" height="400" alt=" Photo"><br>
                   {{ $galeri->deskripsi }}
                  </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <img class="img-fluid" src="{{ asset('images/'.$galeri->foto) }}" width="150" height="150" alt="Photo"><br>
                  </div>
                </div>
